            ...
            <ul className='flex justify-center'>
                {facebook &&
                    <li className='mx-1'>
                        ...
                        >
                            <span className='text-[0px] hidden'>Facebook</span>
                            <span>
                ...
                {Instagram &&
                    <li className='mx-1'>
                        <a
                            ...
                            rel='noopener noreferrer'
                        >
                            <span className='text-[0px] hidden'>Instagram</span>
                            <span>
                ...
                {linkedIn &&
                    <li className='mx-1'>
                        <a
                            ...
                            rel='noopener noreferrer'
                        >
                            <span className='text-[0px] hidden'>LinkedIn</span>
                            <span>
                ...
                {twitter &&
                    <li className='mx-1'>
                        <a
                            ...
                            rel='noopener noreferrer'
                        >
                            <span className='text-[0px] hidden'>Twitter</span>
                            <span>
